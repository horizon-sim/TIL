...
# 스타일 적용
a1.font = Font(color="FF0000", italic=True, bold=True) # 글자 색 빨강, 이탤릭, 두껍게 적용
b1.font = Font(color="CC33FF", name="Arial", strike=True) # 폰트를 Arial 로 설정, 취소선적용
...
for row in ws.rows:
    for cell in row:
        ...
        if isinstance(cell.value, int) and cell.value > 70:
            ...
            cell.font = Font(color="FFFFFF") # 폰트색깔변경
